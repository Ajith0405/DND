        ...
        <AppBar position="static">
          <Toolbar>
            ...
            {/* Workspace Menu Button */}
              <div>
                <Button
                  ...
                  aria-controls={
                    openWorkspace ? "demo-customized-menu-workspace" : undefined
                  }
                  aria-haspopup="true"
            ...
            <Stack spacing={2} direction="row">
              <Button variant="contained" style={{backgroundColor:'whitesmoke', textTransform:'capitalize'}} className="board_create_btn text-dark" >Create</Button>
            </Stack>
            ...
            <NotificationsNoneIcon sx={{ width: 30, height: 30 }} className="notification_icon"/>
            </Tooltip>
            {/* Helpout Icon */}
            <Tooltip title="Help">
            <HelpOutlineIcon sx={{ width: 30, height: 30 }} className="helpout_icon"/>
            </Tooltip>
            {/* User Avatar */}
            <Tooltip title="Account">
            <Avatar sx={{ bgcolor: deepPurple[500],width: 32, height: 32, }} className="user_avatar_logo"><p className="mt-3" style={{display:'flex', alignItems:'center',fontSize:'12px'}}>AS</p></Avatar>
            </Tooltip>
            </Stack>
          </Toolbar>
        </AppBar>
